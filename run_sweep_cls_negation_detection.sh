#!/bin/bash
# =============================================================================
# Sweep: CLS Pooling - Negation Detection Task
# =============================================================================
...
if [ -n "$DRIVE_OUTPUT" ]; then
    OUTPUT_DIR="$DRIVE_OUTPUT/sweep_cls_negation_detection"
    echo "Saving to Google Drive: $OUTPUT_DIR"
else
    OUTPUT_DIR="${OUTPUT_DIR:-experiments/sweep_cls_negation_detection}"
    echo "Saving locally: $OUTPUT_DIR"
fi

echo "========================================"
echo "Layer Sweep: CLS Pooling - NEGATION DETECTION"
echo "========================================"
...
RESULTS_FILE="$OUTPUT_DIR/results_cls_negation_detection.json"
echo "[]" > "$RESULTS_FILE"

for layer in 0 1 2 3 4 5; do
    echo ""
    echo "[Layer $layer] CLS pooling - Negation Detection..."
...
"
        ...
        echo "  ✓ Layer $layer CLS: acc=$ACC, auroc=$AUROC"
    else
...
echo ""
echo "========================================"
echo "CLS Negation Detection Sweep Complete!"
echo "========================================"
