#!/bin/bash
# =============================================================================
# Sweep: TOKEN Pooling Only (Run in its own Colab/terminal)
# =============================================================================
...
SEED="${SEED:-42}"
OUTPUT_DIR="${OUTPUT_DIR:-experiments/sweep_token}"

echo "========================================"
echo "Layer Sweep: TOKEN Pooling"
echo "========================================"
echo "Layers: 0-5"
...
RESULTS_FILE="$OUTPUT_DIR/results_token.json"
echo "[]" > "$RESULTS_FILE"

for layer in 0 1 2 3 4 5; do
    echo ""
    echo "[Layer $layer] TOKEN pooling..."
...
out = {'layer': $layer, 'pooling': 'token', 'test_acc': r.get('test_acc', 0), 'test_auroc': r.get('test_auroc', 0)}
...
"
        ...
        echo "  ✓ Layer $layer TOKEN: acc=$ACC"
    else
